<%@ Page Title="" Language="C#" MasterPageFile="MasterPageRight.master" AutoEventWireup="true" CodeFile="GuanLiYuanZhangHao.aspx.cs" Inherits="NYAdmin_ChanPinGuanLi" %>
...
<asp:Content ID="Content11" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="pageAll">
        ...
        <div class="page">
            <!-- user页面样式 -->
            <div class="cfD">
                <asp:TextBox ID="TBZhangHao" class="addUser"  placeholder="输入帐号" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="TBMiMa" class="addUser"  placeholder="输入密码" runat="server"></asp:TextBox>
                <asp:Button ID="BtSouSuo" class="button" runat="server" Text="添加" 
